...
for i in range(len(M)):
    x1.append(lambda_0(N=4, l=1, u=3, R=8, C=2, O=M[i], a=1, r=1))
    y1.append(lambda_1(N=4, l=1, u=3, R=8, C=2, O=M[i], a=1, r=1))
# print(x1)
# print('\n')
# print(y1)
...
for i in range(len(M)):
    ...
    pso = PSO(func=test1, dim=2, pop=100, max_iter=2000, lb=[0, 0], ub=[1, 1], w=0.9, c1=2, c2=2)
    pso.run()
...
s2 = []
for i in range(len(M)):
    s1.append(social(l_0=x1[i], l_1=y1[i], N=4, l=1, u=3, R=8, C=2, O=M[i], a=1, r=1))
    s2.append(social(l_0=x2[i], l_1=y2[i], N=4, l=1, u=3, R=8, C=2, O=M[i], a=1, r=1))


'''关于u'''
P = np.arange(1.4, 4.6, 0.1)
x3 = []
y3 = []
for i in range(len(P)):
    x3.append(lambda_0(N=4, l=1, u=P[i], R=8, C=2, O=3, a=1, r=1))
    y3.append(lambda_1(N=4, l=1, u=P[i], R=8, C=2, O=3, a=1, r=1))
...
for i in range(len(P)):
    ...
    def test2(l_0, l_1):
        return -social2(l_0, l_1)
    pso = PSO(func=test2, dim=2, pop=100, max_iter=2000, lb=[0, 0], ub=[1, 1], w=0.9, c1=2, c2=2)
    pso.run()
...
s4 = []
for i in range(len(P)):
    s3.append(social(l_0=x3[i], l_1=y3[i], N=4, l=1, u=P[i], R=8, C=2, O=3, a=1, r=1))
    s4.append(social(l_0=x4[i], l_1=y4[i], N=4, l=1, u=P[i], R=8, C=2, O=3, a=1, r=1))
